...
class FlutterSwitch extends StatefulWidget {
  ...
  final Color activeColor,
      ...
      inactiveTextColor,
      toggleColor,
      inactiveToggleIconColor,
      activeToggleIconColor;

  final double width, height, toggleSize, valueFontSize, borderRadius, padding, toggleIconSize;
  final IconData toggleIconOn, toggleIconOff;
  ...
  const FlutterSwitch({
    ...
    this.inactiveToggleIconColor = Colors.grey,
    this.activeToggleIconColor = Colors.grey,
    this.width = 70.0,
    this.height = 35.0,
                ...
                Align(
                  ...
                  child: Container(
                    ...
                    child: Icon(
                      widget.value
                          ? widget.toggleIconOn
                          : widget.toggleIconOff,
                      color: widget.value
                          ? widget.activeToggleIconColor
                          : widget.inactiveToggleIconColor,
                      size: widget.toggleIconSize,
                    ),
                  ),
                ),
